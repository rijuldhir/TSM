...
if __name__ == '__main__':
    ...
    files_input = ['../../dataset/%s-fewshot-validation.json' % dataset_name, '../../dataset/%s-fewshot-train.json' % dataset_name, '../../dataset/%s-test.json' % dataset_name]
    files_output = ['val_fewshot_videofolder.txt', 'train_fewshot_videofolder.txt', 'test_videofolder.txt']
