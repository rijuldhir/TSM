...
def return_somethingv2_few(modality):
    filename_categories = '/home/rijul/temporal-shift-module/tools/category.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'dataset/20bn-something-something-v2-frames'
        filename_imglist_train = '/home/rijul/temporal-shift-module/tools/train_fewshot_videofolder.txt'
        filename_imglist_val = '/home/rijul/temporal-shift-module/tools/val_fewshot_videofolder.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
        root_data = ROOT_DATASET + 'something/v2/20bn-something-something-v2-flow'
        filename_imglist_train = 'something/v2/train_videofolder_flow.txt'
...
def return_somethingv2_down(modality):
    filename_categories = '/home/rijul/temporal-shift-module/tools/category.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'dataset/20bn-something-something-v2-frames'
        filename_imglist_train = '/home/rijul/temporal-shift-module/tools/train_downsample_videofolder.txt'
        filename_imglist_val = '/home/rijul/temporal-shift-module/tools/val_downsample_videofolder.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
        root_data = ROOT_DATASET + 'something/v2/20bn-something-something-v2-flow'
        filename_imglist_train = 'something/v2/train_videofolder_flow.txt'
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2, 'somethingv2few': return_somethingv2_few,'somethingv2down': return_somethingv2_down,'ucf101': return_ucf101, 'hmdb51': return_hmdb51,
